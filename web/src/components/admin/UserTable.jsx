                  ...
                  <tr key={user.id} className="border-b border-white/5 hover:bg-white/5 transition">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex gap-2">
                        <button onClick={() => setRoleModalUser(user)} className="admin-action-btn admin-action-btn--edit" title={`Change role to ${user.role === 'ADMIN' ? 'USER' : 'ADMIN'}`}>
                          Edit
                        </button>
                        <button
                          disabled={isSelf}
